...
const Storyblok = new StoryblokClient({
  accessToken: "CQ5CbFz9QXEJ0enlvMIWNwtt",
  cache: {
    clear: "auto",
    type: "memory"
  }
...
/* harmony default export */ __webpack_exports__["default"] = (async (req, res) => {
  ...
  */
  ...
  Storyblok.get(`cdn/stories/root/${slug}`, {}).then(response => {
    const {
      data: {
        story: {
          content
...
module.exports = __webpack_require__(/*! D:\Code\NextJS\react-storyblok-next-boilerplate-master\pages\api\page\[slug].js */"./pages/api/page/[slug].js");
